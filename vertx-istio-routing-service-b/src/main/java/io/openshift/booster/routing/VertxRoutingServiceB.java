...
public class VertxRoutingServiceB extends AbstractVerticle {
  ...
  private void random(RoutingContext rc) {
    ...
    vertx.setTimer(delay, x ->
      rc.response().end("Hello from Service B! Operation completed in " + (System.currentTimeMillis() - started) + "ms."));
  }
}
